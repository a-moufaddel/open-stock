...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see org.appfuse.tutorial.service.impl.PasswordTokenManager#generateRecoveryToken(org.appfuse.tutorial.model.User)
     */
    @Override
    ...
    /**
     * @see org.appfuse.tutorial.service.impl.PasswordTokenManager#isRecoveryTokenValid(org.appfuse.tutorial.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see org.appfuse.tutorial.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
